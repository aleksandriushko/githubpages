            ...
            <div class="row align-items-end">
                <div class="col-lg-6">
                    <div class="info">
                        <div class="bk-hover mb--40">
                            ...
                            <p class="bk_pra font-16">Your address goes here</p>
                ...
                <div class="col-lg-6">
                    <div class="copyright-right text-right">
                        <p class="bk_pra font-16">
                            &copy; 2021 <b class="text-white">Brook</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>HasThemes</b></a>
                        </p>
                    </div>
                </div>
            </div>
